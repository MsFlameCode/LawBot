...
def create_inline_board_service():
    ...
    inline_btn_15 = InlineKeyboardButton('испольнительное производство', callback_data='btn_ser15')
    inline_kb_full.add(inline_btn_15)
    inline_btn_16 = InlineKeyboardButton('ДТП', callback_data='btn_ser16')
    inline_kb_full.add(inline_btn_16)
    inline_btn_17 = InlineKeyboardButton('воинский учет', callback_data='btn_ser17')
    inline_kb_full.add(inline_btn_17)
    inline_btn_18 = InlineKeyboardButton('оформление гражданства / визы', callback_data='btn_ser18')
    inline_kb_full.add(inline_btn_18)
    inline_btn_19 = InlineKeyboardButton('судебная экспертиза', callback_data='btn_ser19')
    inline_kb_full.add(inline_btn_19)
    inline_btn_20 = InlineKeyboardButton('иное', callback_data='btn_ser20')
    inline_kb_full.add(inline_btn_20)

    return inline_kb_full


def create_keyboard_for_real_estate():
    inline_btn_1 = InlineKeyboardButton('консультация', callback_data='btn_type1')
    inline_kb_full = InlineKeyboardMarkup(row_width=1).add(inline_btn_1)
    inline_btn_2 = InlineKeyboardButton('составить договор', callback_data='btn_type4')
    inline_kb_full.add(inline_btn_2)
    inline_btn_3 = InlineKeyboardButton('представление интересов в суде', callback_data='btn_type3')
    inline_kb_full.add(inline_btn_3)
    inline_btn_4 = InlineKeyboardButton('узаконить/согласовать перепланировку', callback_data='btn_type5')
    inline_kb_full.add(inline_btn_4)
    inline_btn_5 = InlineKeyboardButton('получить разрешение на строительство', callback_data='btn_type6')
    inline_kb_full.add(inline_btn_5)
    inline_btn_6 = InlineKeyboardButton('уменьшить кадастровую стоимость объекта/земли', callback_data='btn_type7')
    inline_kb_full.add(inline_btn_6)
    inline_btn_7 = InlineKeyboardButton('участие юриста/эксперта при приемке квартиры от застройщика',
                                        callback_data='btn_type8')
    inline_kb_full.add(inline_btn_7)

    inline_btn_8 = InlineKeyboardButton('оформить претензию к застройщику  о неустойке', callback_data='btn_type9')
    inline_kb_full.add(inline_btn_8)
    inline_btn_9 = InlineKeyboardButton('участие юриста/эксперта при приемке квартиры от застройщика',
                                        callback_data='btn_type10')
    inline_kb_full.add(inline_btn_9)
    return inline_kb_full
...
def create_inline_board_service_type():
    inline_btn_1 = InlineKeyboardButton('консультация', callback_data='btn_type1')
    inline_kb_full = InlineKeyboardMarkup(row_width=1).add(inline_btn_1)
    inline_btn_2 = InlineKeyboardButton('составить договор', callback_data='btn_type2')
    inline_kb_full.add(inline_btn_2)
    inline_btn_3 = InlineKeyboardButton('представление интересов в суде', callback_data='btn_type3')
    inline_kb_full.add(inline_btn_3)
